...
var generateJoke = function generateJoke() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get(url, config).then(function (res) {
    return document.querySelector('#joke').innerHTML = res.data.joke;
  });
};
...
var laughImg = document.querySelector('#laughImg');
...
/******/ })()
;
//# sourceMappingURL=bundle231ecdc73fb41612674f.js.map